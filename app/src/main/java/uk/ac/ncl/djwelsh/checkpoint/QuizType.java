...
public class QuizType extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.quiz_type, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_home :
                Intent a = new Intent(QuizType.this, MainActivity.class);
                startActivity(a);
                break;
            case R.id.nav_subjects :
                Intent b = new Intent(QuizType.this, SubjectList.class);
                startActivity(b);
                break;
            case R.id.nav_results :
                Intent c = new Intent(QuizType.this, SubjectResults.class);
                startActivity(c);
                break;
        }
